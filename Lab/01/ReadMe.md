...
<h2>Выполнение работы</h2>
 ...
 <br>2) Далее был сделан базовый клиент сервера, который в дальнейшем будет редактироваться.<br>
 
 ![](./images/pic0.png)
 <br>рис.1 Клиент
 <br>3) Изучили пример ответа от сайта worldtimeapi<br>
 
 ![](./images/pic1.png)
 <br>рис.2 Ответ сайта
 <br>4) Написали серверное приложение на языке C++
...
```
 <br>
 <br>5) Далее написал клиентское приложение на языке Python
...
```
 <br>
 <br>6) Был сделан графический интерфейс приложения<br>
 
 ![](./images/pic2.png)
 <br>рис.3 графический интерфейс
 <br>7) А вот и готовый вариант задачи<br>
 
 ![](./images/pic3.png)
 <br>рис.4 Итог
 <br>Вывод: по итогу была создана программа, посылающая запрос на сервер и выводящая уже обработтаные данные с сайта на личный сервер. За время выполнения данной лабораторной работы я приобрёл множество знаний в создании сервера, получения и обработки информации. Научился создавать графический интерфейс с помощью tkinter и в принципе приобрёл много опыта.
